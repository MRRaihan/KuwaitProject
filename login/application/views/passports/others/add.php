...
<div class="content-wrapper">
  ...
  <h3 class="box-title">Add Other</h3>
    </div>
    
  
  <div class="box-body">
  <form action="<?php echo base_url(); ?>passports/create_other" method="post" id="basic-form" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input name="remarks" type="text" class="form-control" placeholder="Enter Remarks" id="remarks">
  </div>
  ...
  <div class="form-group">
   ...
   <textarea class="form-control" rows="4" cols="50" name="mailing_address" autocomplete="off" placeholder="Enter Mailing Address"></textarea>
  </div>
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input name="bd_mobile" type="number" class="form-control" placeholder="Enter Bangladesh Mobile Number " id="bd_mobile">
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
  ...
  <div class="col-md-6">
   ...
   <div class="form-group">
      <label for="fee">Fee</label>
       <input class="form-control" name="fee" type="number" class="form-control" placeholder="Total fee" id="fee" required="">
    </div>
    </div>
