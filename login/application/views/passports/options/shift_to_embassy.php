<?php $type = isset($_GET['type']) ? $_GET['type'] : 'lost';
$uid = '';
...
<div class="content-wrapper">
    ...
    <div class="row">
          <form action="<?php echo base_url(); ?>passports/reports_table" method="get" id="searchList">
            ...
            <input type="hidden" name="type" value="shift_to_embassy" / >
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <form action="<?php echo base_url(); ?>passports/shift_passport/<?php echo $type; ?>/?id=" method="post">
                      
                  <center><button type="submit" class=" btn btn-success" style="text-align:center"> Shift To Embassy </button> 
                  </center>
         ...
         $passports = $this->passport_model->get_passports($args);
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                           <?php if ( $record->is_shifted > 0 ) : ?>
                           
                            <a class="btn btn-sm btn-success" href="javascript:void(0);" title="Already Shifted"><i class="fa fa-check"></i> Already Shifted </a>
                            
                            
                            <?php if ( $role == ROLE_ADMIN || $role == ROLE_MANAGER ) { ?>
                            <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>passports/shift_passport/<?php echo $type; ?>/undo/?id=<?php echo $record->id; ?>" title="Undo"><i class="fa fa-trash"></i> Undo </a>
                            <?php } ?>
                            
                            
                            
                        <?php else : ?>
                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" title="Pending Shift"><i class="fa fa-clock-o"></i> Pending Shift </a>
                           <?php endif; ?>
                        </td>
                    </tr>
                    <?php
