...
<div class="content-wrapper">
   ...
   <div class="prints">
        ...
        <a target="_blank" class="btn btn-success" href="<?php echo base_url(); ?>passports/print_passport?type=extend&id=<?php echo $passport->id; ?>" title="Print"><i class="fa fa-file-pdf-o"></i> Print Recpt </a>
                            
        <a target="_blank" class="btn btn-danger" href="<?php echo base_url(); ?>passports/print_passport?type=extend&id=<?php echo $passport->id; ?>&bar_code" title="Print"><i class="fa fa-eye"></i> Print Sticker </a>
  ...
  <h3 class="box-title">Edit Renewal Passport</h3>
    </div>
    
  <div class="box-body">
      
  <form action="<?php echo base_url(); ?>passports/update_extending_passport" method="post" id="basic-form" enctype="multipart/form-data">
