...
<div class="content-wrapper">
  ...
  <h3 class="box-title">Add Lost Passport</h3>
    </div>
    
  
  <div class="box-body">
  <form action="<?php echo base_url(); ?>passports/create_lost_passport" method="post" id="basic-form" enctype="multipart/form-data">
