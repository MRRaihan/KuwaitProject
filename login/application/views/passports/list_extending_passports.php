        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>passports/add_extending_passport"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <?php } ?>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Extending Passports</h3>
                ...
                <?php
                  ...
                  if(  isset($_GET['branch_id'])  && is_numeric( $_GET['branch_id'] ) ){
                      $passports = $this->passport_model->get_extending_passports($_GET['branch_id']);
                      $count = $this->passport_model->get_extending_passports_count($_GET['branch_id']); 
                  } else {
                     $passports = $this->passport_model->get_extending_passports(); 
                     $count = $this->passport_model->get_extending_passports_count(); 
                  }
                 
                 }
                  else {
                    $passports = $this->passport_model->get_extending_passports($user_id);
                    $count = $this->passport_model->get_extending_passports_count($user_id); 
                  }
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a target="_blank" href="<?php echo base_url(); ?>passports/view_passport?type=extend&id=<?php echo $record->id; ?>" class="btn btn-sm btn-primary" href="" title="View"><i class="fa fa-eye"></i> View </a>
                            
                            
                            <a target="_blank" href="<?php echo base_url(); ?>passports/print_passport?type=extend&id=<?php echo $record->id; ?>" class="btn btn-sm btn-primary" href="" title="View"><i class="fa fa-file-pdf-o"></i> Print Recpt </a>
                            
                            <a target="_blank" href="<?php echo base_url(); ?>passports/print_passport?type=extend&id=<?php echo $record->id; ?>&bar_code" class="btn btn-sm btn-primary" href="" title="View"><i class="fa fa-eye"></i> Print Sticker </a>
                            
                            <?php if ( $role == ROLE_ADMIN || $role == ROLE_MANAGER || $role == 5 ) : ?>
                            <a class="btn btn-sm btn-info" href="<?php echo base_url(); ?>passports/edit_extending_passport?id=<?php echo $record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                            <?php endif; ?>
                            
                            
                             <?php if ( $role == ROLE_ADMIN ) : ?>
                            <a onclick="return confirm('Are you sure you want to delete this item?');" title="Delete" class="btn btn-sm btn-danger deleteUser" href="<?php echo base_url(); ?>passports/delete_passport/extend/<?php echo $record->id; ?>?redirect=list_extending_passports"><i class="fa fa-trash"></i></a>
                            <?php endif; ?>
                ...
                <div class="box-footer clearfix">
                   <nav>
                   <?php $current = isset ($_GET['page']) ? $_GET['page'] : 1;
