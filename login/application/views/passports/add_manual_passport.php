...
<div class="content-wrapper">
  ...
  <h3 class="box-title">Add Manual Extent On Passport</h3>
    </div>
    
  <div class="box-body"> 
  <form action="<?php echo base_url(); ?>passports/create_manual_passport" method="post" id="basic-form" enctype="multipart/form-data">
  ...
  <div class="col-md-6"><div class="form-group">
    ...
    <input class="form-control" name="post_office" type="text" class="form-control" placeholder="Enter Post Office ID" id="post_office" autocomplete="off">
  </div>
  </div>
