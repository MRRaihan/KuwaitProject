...
<div class="content-wrapper">
  ...
  <h3 class="box-title">Edit Lost Passport</h3>
    </div>
                    
  
  <div class="box-body"> 
  <form action="<?php echo base_url(); ?>passports/update_lost_passport" method="post" id="basic-form" enctype="multipart/form-data">
